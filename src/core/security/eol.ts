/**
 * Manel Core — End-of-Life (EOL) Dates
 *
 * Known EOL dates for common development technologies.
 * Used to flag outdated or unsupported versions.
 *
 * @module core/security/eol
 */

/**
 * EOL dates by technology.
 * Each entry maps a technology name to an array of version/EOL pairs.
 */
